...
const CACHE_NAME = 'scs-app-build-1104-neutral-safe-area';
const APP_SHELL = './index.html?v=1103';

const ASSETS = [
  APP_SHELL,
  './ui.css?v=1104', './rounds.css?v=1004',
  ...
  './engjap.js?v=864', './main.js?v=1104', './games.js?v=1019',
