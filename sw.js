...
const CACHE_NAME = 'scs-cache-1153';
const APP_SHELL = './index.html?v=1153';

const ASSETS = [
  APP_SHELL,
  './ui.css?v=1141', './rounds.css?v=1004',
  ...
  './engjap.js?v=864', './main.js?v=1150', './games.js?v=1019',
  ...
  './slots.js?v=1136', './notifications.js?v=856', './viewer.js?v=1153',
