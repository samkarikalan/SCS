...
const CACHE_NAME = 'scs-cache-1132';
const APP_SHELL = './index.html?v=1106';

const ASSETS = [
  APP_SHELL,
  './ui.css?v=1132', './rounds.css?v=1004',
  ...
  './engjap.js?v=864', './main.js?v=1106', './games.js?v=1019',
  ...
  './slots.js?v=1121', './notifications.js?v=856', './viewer.js?v=856',
