...
const CACHE_NAME = 'scs-cache-1155';
const APP_SHELL = './index.html?v=1155';

const ASSETS = [
  APP_SHELL,
  './ui.css?v=1141', './rounds.css?v=1155',
  ...
  './slots.js?v=1136', './notifications.js?v=856', './viewer.js?v=1155',
