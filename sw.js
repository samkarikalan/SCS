...
const CACHE_NAME = 'scs-app-build-1105-opaque-statusbar';
const APP_SHELL = './index.html?v=1105';

const ASSETS = [
  APP_SHELL,
  './ui.css?v=1105', './rounds.css?v=1004',
  ...
  './engjap.js?v=864', './main.js?v=1105', './games.js?v=1019',
