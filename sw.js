...
const CACHE_NAME = 'scs-app-build-1066-round-player-safearea-fix';
const APP_SHELL = './index.html?v=1064';

const ASSETS = [
  APP_SHELL,
  './ui.css?v=1066', './rounds.css?v=1004',
  './offline-db.js?v=917', './offline-rounds.js?v=979', './snapshot.js?v=891', './supabase.js?v=936', './auth.js?v=856',
  './authUI.js?v=1047', './subscription.js?v=856', './HomeScreen.js?v=1066',
  './engjap.js?v=864', './main.js?v=1066', './games.js?v=1019',
