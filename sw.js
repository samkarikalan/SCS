...
const CACHE_NAME = 'scs-cache-1154';
const APP_SHELL = './index.html?v=1154';

const ASSETS = [
  APP_SHELL,
  './ui.css?v=1141', './rounds.css?v=1154',
  ...
  './slots.js?v=1136', './notifications.js?v=856', './viewer.js?v=1154',
