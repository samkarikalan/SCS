...
const CACHE_NAME = 'scs-cache-1156';
const APP_SHELL = './index.html?v=1156';

const ASSETS = [
  APP_SHELL,
  './ui.css?v=1141', './rounds.css?v=1156',
  ...
  './slots.js?v=1136', './notifications.js?v=856', './viewer.js?v=1156',
